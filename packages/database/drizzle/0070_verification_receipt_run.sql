-- Existing receipt rows predate the Run binding and have no sound way to
-- reconstruct one. Keep their binding null rather than fabricating a Run.
ALTER TABLE "verification_receipts" ADD COLUMN "run_id" text;
