...
| PR-F | 视觉 capture 工具（scripts/visual-capture.mjs，含错误页判废与 --dark）+ 基线 docs/design/baseline/：9 路由 × {1440,390} × {light,dark} = 36 张全部通过 DOM 巡检（数据态、无错误横幅、marker 在场）后入库；loading/error/404 态截图仍待补 | done |
